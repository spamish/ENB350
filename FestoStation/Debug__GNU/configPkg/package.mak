...
ti.targets.arm.elf.M4F.rootDir ?= C:/ti/ccsv6/tools/compiler/gcc-arm-none-eabi-4_8-2014q3
...
FestoStation.xem4f: package/cfg/FestoStation_pem4f.oem4f 
	...
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/lnk470 -w -q -u _c_int00  -q -o $@ package/cfg/FestoStation_pem4f.oem4f   package/cfg/FestoStation_pem4f.xdl --silicon_version=7M4 --strict_compatibility=on -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
