...
override PKGDIR = xconfig_FestoStation
...
C:/ti/tirtos_tivac_2_12_01_33/products/bios_6_41_04_54/packages/ti/targets/ITarget.xs:
package.mak: C:/ti/tirtos_tivac_2_12_01_33/products/bios_6_41_04_54/packages/ti/targets/ITarget.xs
C:/ti/tirtos_tivac_2_12_01_33/products/bios_6_41_04_54/packages/ti/targets/C28_large.xs:
package.mak: C:/ti/tirtos_tivac_2_12_01_33/products/bios_6_41_04_54/packages/ti/targets/C28_large.xs
C:/ti/tirtos_tivac_2_12_01_33/products/bios_6_41_04_54/packages/ti/targets/C28_float.xs:
package.mak: C:/ti/tirtos_tivac_2_12_01_33/products/bios_6_41_04_54/packages/ti/targets/C28_float.xs
C:/ti/tirtos_tivac_2_12_01_33/products/bios_6_41_04_54/packages/ti/targets/package.xs:
package.mak: C:/ti/tirtos_tivac_2_12_01_33/products/bios_6_41_04_54/packages/ti/targets/package.xs
C:/ti/tirtos_tivac_2_12_01_33/products/bios_6_41_04_54/packages/ti/targets/arm/elf/IArm.xs:
package.mak: C:/ti/tirtos_tivac_2_12_01_33/products/bios_6_41_04_54/packages/ti/targets/arm/elf/IArm.xs
C:/ti/tirtos_tivac_2_12_01_33/products/bios_6_41_04_54/packages/ti/targets/arm/elf/package.xs:
package.mak: C:/ti/tirtos_tivac_2_12_01_33/products/bios_6_41_04_54/packages/ti/targets/arm/elf/package.xs
...
ti.targets.arm.elf.M4F.rootDir ?= C:/ti/ccsv6/tools/compiler/ti-cgt-arm_5.2.2
ti.targets.arm.elf.packageBase ?= C:/ti/tirtos_tivac_2_12_01_33/products/bios_6_41_04_54/packages/ti/targets/arm/elf/
...
package/%.xdc.inc package/%_xconfig_FestoStation.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_FestoStation" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: FestoStation.pem4f

-include package/cfg/FestoStation_pem4f.mak
-include package/cfg/FestoStation_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/FestoStation_pem4f.dep
endif
FestoStation.pem4f: package/cfg/FestoStation_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
FestoStation.pem4f package/cfg/FestoStation_pem4f.c: .libraries,em4f
endif

package/cfg/FestoStation_pem4f.c package/cfg/FestoStation_pem4f.h package/cfg/FestoStation_pem4f.xdl: override _PROG_NAME := FestoStation.xem4f
package/cfg/FestoStation_pem4f.c: package/cfg/FestoStation_pem4f.cfg
package/cfg/FestoStation_pem4f.xdc.inc: package/cfg/FestoStation_pem4f.xdl
package/cfg/FestoStation_pem4f.xdl package/cfg/FestoStation_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/FestoStation_pem4f.cfg
	-$(RM) package/cfg/FestoStation_pem4f.dep
	-$(RM) package/cfg/FestoStation_pem4f.c
	-$(RM) package/cfg/FestoStation_pem4f.xdc.inc

clean,em4f::
	-$(RM) FestoStation.pem4f
.executables,em4f .executables: FestoStation.xem4f

FestoStation.xem4f: |FestoStation.pem4f

-include package/cfg/FestoStation.xem4f.mak
FestoStation.xem4f: package/cfg/FestoStation_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armlnk -w -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@).  -q -o $@ package/cfg/FestoStation_pem4f.oem4f   package/cfg/FestoStation_pem4f.xdl --silicon_version=7M4 --strict_compatibility=on -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
FestoStation.xem4f: export C_DIR=
FestoStation.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
FestoStation.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

FestoStation.test test,em4f test: FestoStation.xem4f.test

FestoStation.xem4f.test:: FestoStation.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 FestoStation.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.FestoStation.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,FestoStation.xem4f,*)


clean:: clean,em4f

clean,em4f::
	-$(RM) FestoStation.xem4f
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
FestoStation_pem4f.oem4f,copy : package/cfg/FestoStation_pem4f.oem4f
FestoStation_pem4f.sem4f,copy : package/cfg/FestoStation_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_FestoStation
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_FestoStation.tar.dep
endif
package/rel/xconfig_FestoStation/xconfig_FestoStation/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_FestoStation/xconfig_FestoStation/package/package.rel.xml: package/build.cfg
package/rel/xconfig_FestoStation/xconfig_FestoStation/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_FestoStation/xconfig_FestoStation/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_FestoStation.tar: package/rel/xconfig_FestoStation.xdc.inc package/rel/xconfig_FestoStation/xconfig_FestoStation/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_FestoStation.xdc.inc,package/rel/xconfig_FestoStation.tar.dep)


release release,xconfig_FestoStation: all xconfig_FestoStation.tar
clean:: .clean
	-$(RM) xconfig_FestoStation.tar
	-$(RM) package/rel/xconfig_FestoStation.xdc.inc
	-$(RM) package/rel/xconfig_FestoStation.tar.dep
