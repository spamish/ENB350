...
#include "kentec320x240x16_ssd2119.h"
...
Kentec320x240x16_SSD2119Init(uint32_t ui32SysClock)
{
    ...
    //
    ui32ClockMS = CYCLES_FTIME_US(ui32SysClock, 1000);
    ...
    //
    sTimings.ui8WSSetup = CYCLES_FTIME_NS(ui32SysClock, 5);
    sTimings.ui8WSDuration = CYCLES_FTIME_NS(ui32SysClock, 40);
    sTimings.ui8WSHold = CYCLES_FTIME_NS(ui32SysClock, 5);
    sTimings.ui8RSSetup = CYCLES_FTIME_NS(ui32SysClock, 0);
    sTimings.ui8RSDuration = CYCLES_FTIME_NS(ui32SysClock, 500);
    sTimings.ui8RSHold = CYCLES_FTIME_NS(ui32SysClock, 100);
    sTimings.ui8DelayCycles = CYCLES_FTIME_NS(ui32SysClock, 50);
